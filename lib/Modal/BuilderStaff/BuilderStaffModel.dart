...
class BuilderStaffModal {

  String? id;
  BuilderTypeModel? visitortype;
  ImageModel? image;
  ImageModel? image_other;
  CourierType? courier_type;
  StaffTypeModel? staff_type;
  ...
  BuilderStaffModal.fromJson(Map<String, dynamic> json) {
    // debugger();
    id = json['id'].toString();
    ...
    try{if (json['visitor_type'] != null) {
      ...
      visitortype = BuilderTypeModel.fromJson(json['visitor_type']);
      // print(visitortype);
    }}catch(ex){print(ex);}
    ...
    try{ if (json['staff_type'] != null) {
      staff_type = StaffTypeModel.fromJson(json['staff_type']);
    }}catch(ex){print(ex); }
...
class BuilderTypeModel {
  ...
  BuilderTypeModel.fromJson(Map<String, dynamic> json) {
    id = json['id'].toString();
    type = json['type'].toString();
...
class BuilderStaffModalNew {
  ...
  BuilderStaffModalNew.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    number = json['number'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['gatekeeperid'] = this.gatekeeperid;
