...
class VisitorModal {
  ...
  VisitorModal.fromJson(Map<String, dynamic> json) {
    // debugger();
    id = json['id'].toString();
    ...
    try{if (json['visitor_type'] != null) {
     // print(json['visitor_type']);
        visitortype = VisitorTypeModel.fromJson(json['visitor_type']);
         // print(visitortype);
      }}catch(ex){print(ex);}
...
class VisitorModelNew {
  ...
  VisitorModelNew.fromJson(Map<String, dynamic> json) {
    // debugger();
    id = json['id'].toString();
    visitor_role=json['role'].toString();
    mobile=json['contact'].toString();
    personname=json['personname'].toString();
    profile=json['profile'].toString();
    unitdetails=json['fullunitdetails'].toString();
    ...
    print("TOTAL========================>"+totaldurations.toString());
  }

  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = <String, dynamic>{};
    data['id'] = id;
    data['role'] = visitor_role;
    data['contact'] = mobile;
    data['personname'] = personname;
    data['profile'] = profile;
    data['fullunitdetails'] = unitdetails;
